...
{
    /// <summary>
    /// This class just tests the grades enumeration names and descriptions
    /// </summary>
    public class StudentGrades
    {
        ...
        public void Run()
        {
            ...
            while (repeat)
            {
                ConsoleHelper.OutputHeading("Students Grades");
                InputMarks();
            }
        }

        /// <summary>
        /// This method contains the name of all ten students, then runs the methods to input a mark, output a grade,
        /// calculate the statistics and finally calculate the grade profiles of every student.
        /// </summary>
        public StudentGrades()
        {
            Students = new string[] { "Charles", "Carlos", "Lewis", "George", "Kevin", "Valterri", "Esteban", "Yuki", "Fernando", "Zhou", };
        ...
        /// <summary>
        /// This method outputs the name of the students and the
        ...
        /// (Fail). If an invalid grade is entered, the method will output X.
        /// </summary>
