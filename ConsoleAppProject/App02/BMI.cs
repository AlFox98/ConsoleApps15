...
namespace ConsoleAppProject.App02
{
    ...
    public class BMI_Calculator
    {
        ...
        public void ConvertBMI()
        {
            ...
            Console.WriteLine($"You have selected {unitChoice}!");
        ...
        {
            Console.WriteLine($"Enter your height" + " to the nearest feet & inches");
            Height = ConsoleHelper.InputNumber($"Enter your height in feet > ");
            int inches = (int)ConsoleHelper.InputNumber($" Enter your height in inches > ", 0, INCHES_IN_FEET);
            Height = Height * INCHES_IN_FEET + inches;
            Console.WriteLine($"Enter your weight" + " to the nearest stones & pounds");
            Weight = ConsoleHelper.InputNumber($"Enter your weight in stone > ");
        ...
        private void InputMetric()
        {
            ...
            Height = ConsoleHelper.InputNumber($"Enter your height in metres > ");
            Console.WriteLine($"Enter your weight " + "to the nearest kilogram");
            Weight = ConsoleHelper.InputNumber($"Enter your weight in kilograms > ");
        }
